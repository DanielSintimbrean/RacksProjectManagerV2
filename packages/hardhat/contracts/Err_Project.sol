...
error Project_MaxMembersNumberExceededErr();
error Project_MemberAlreadyExistsErr();
error Project_MemberIsBannedErr();
error Project_MemberHasNoReputationEnoughErr();
...
error Project_TransferGiveAwayFailed();
